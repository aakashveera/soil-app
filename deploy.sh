...
#docker build -t aakashveera/soil-predictor:latest -t aakashveera/soil-predictor:$GIT_SHA -f ./soiltype/Dockerfile ./soiltype
#docker build -t aakashveera/disease-predictor:latest -t aakashveera/disease-predictor:$GIT_SHA -f ./disease/Dockerfile ./disease
